import { useBottomSheetStore } from '@/store/cart';
...
const BottomSheet = (
    ...
    return (
        <>
            ...
            <Transition
                onClick={closeCart} className={`fixed top-0 left-0 right-0 bottom-0 bg-black bg-opacity-30 z-40 `}
                show={isOpened}
            ...
            >
                ...
                <div role='button' className='absolute w-8 h-8 top-4 right-4' onClick={closeCart}>
                    <XMarkIcon />
                </div>
            </Transition>
        </>

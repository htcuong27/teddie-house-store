...
const CharmItem = ({ onClickBuy, onClickAddToCart, charm }: CharmItemProps) => {
        ...
        <li className='flex flex-col'>
            <a className="flex flex-col group bg-white border shadow-sm rounded-xl overflow-hidden hover:shadow-lg transition " href="#">
                <div className="relative pt-[100%] rounded-t-xl overflow-hidden">
                    <Image className="w-full h-full absolute top-0 start-0 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out rounded-t-xl" width={1000} height={1000} src={charm.imageUrl} alt="Image Description" />
                </div>
